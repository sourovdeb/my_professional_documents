# 08 — Automation (so you only have to write)

> Companion to this file: **`job_search_config.yml`** in this folder — one place to keep
> your search terms, job boards, fit criteria, and outreach targets. Every tool below
> reads from it. Never put passwords or API keys in it.
...
- New essay published → auto-cross-post hook to LinkedIn + log a line in `Growth_Hub/PUBLISHED_LOG.md`.
...
- **If a flow breaks and stresses you, delete it.** The streak (00_START_HERE) matters more than any pipeline.
